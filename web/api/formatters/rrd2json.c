...
int rrdset2value_api_v1(
    ...
    RRDR *r = rrd2rrdr(st, points, after, before, group_method, group_time, options, 0, dimensions, NULL);
...
int rrdset2anything_api_v1(
    ...
    RRDR *r = rrd2rrdr(st, points, after, before, group_method, group_time, options, stats, dimensions?buffer_tostring(dimensions):NULL, context_param_list);
    if(!r) {
